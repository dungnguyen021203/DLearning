package com.example.dlearning.presentation.ui.auth
...
import com.example.dlearning.presentation.components.AuthHeader
...
@Composable
fun ForgetPasswordScreen(viewModel: AuthViewModel = hiltViewModel(), navController: NavHostController) {
    ...
    Column(
        ...
        Text(text = "Welcome to DLearning", fontSize = 24.sp, fontWeight = FontWeight.ExtraBold)
